...
namespace Managers
{
    ...
    //     {
    //         _ibarra = CharacterManager.Instance.GetCharacter("Ibarra");
    //         _maria = CharacterManager.Instance.GetCharacter("Maria");
    //         _boss = CharacterManager.Instance.GetCharacter("Boss");
    //
    //         UpdateStats();
    //     }
    //
